...
const DatePickerWithHighlights: React.FC<DatePickerProps> = ({
  highlightDates,
  selectedDate: initialSelectedDate,
  onDateChange,
}) => {
  const [selectedDate, setSelectedDate] = useState<string>(initialSelectedDate || getCurrentDate());
  ...
  const modifiersClassNames = {
    highlight: 'bg-[#8DFF00]  rounded-full',
  };
